...
<div class="min-h-screen bg-background p-4">
  <div class="container mx-auto max-w-4xl py-8">
    ...
    <!-- Import Message -->
    {#if importMessage}
      <div class="mb-4 p-4 rounded-lg {importMessage.type === 'success' ? 'bg-success/20 border border-success text-success-light' : 'bg-danger/20 border border-danger text-danger-light'}">
        {importMessage.text}
      </div>
    {/if}
        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-3">
              ...
              <div class="space-y-2">
                {#each abilities as ability}
                  ...
                  <div class="flex justify-between items-center p-3 bg-neutral-light/20 dark:bg-neutral-dark rounded">
                    <span class="font-medium">{ability.label}</span>
                    <div class="text-right">
                      <div class="font-bold text-lg">
                        {finalScore}
                        {#if bonus > 0}
                          <span class="text-sm text-success">(+{bonus})</span>
                        {/if}
                      </div>
            ...
            <div class="space-y-3">
              ...
              <div class="space-y-2">
                <div class="p-3 bg-magic-light/20 dark:bg-magic-dark rounded">
                ...
                <div class="p-3 bg-info-light/20 dark:bg-info-dark rounded">
              ...
              {#if characterStore.character.race?.traits && characterStore.character.race.traits.length > 0}
                <div class="p-3 bg-success-light/20 dark:bg-success-dark rounded">
      ...
      <div class="flex justify-between items-center">
        {#each steps as step, index}
          <div class="flex flex-col items-center flex-1">
            ...
            <span class="text-xs mt-2 text-center text-muted-foreground">{step.title}</span>
          </div>
    ...
    <Card class="p-8">
      ...
      {#if currentStep === 0}
        <div class="space-y-6">
          ...
          {#if nameInput.trim()}
            <div class="p-4 bg-magic-light/20 dark:bg-magic-dark rounded-lg">
              <p class="text-sm text-magic-dark dark:text-magic-light">
      ...
      {#if currentStep === 1}
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            {#each abilities as ability}
              <div class="space-y-2 p-4 border rounded-lg bg-neutral-light/10 dark:bg-neutral-dark">
          ...
          <div class="p-4 bg-info-light/20 dark:bg-info-dark rounded-lg">
            <h3 class="font-semibold text-info-dark dark:text-info-light mb-2">
      ...
      {#if currentStep === 2}
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
              {#each availableRaces as race}
                <button
                  ...
                  class="p-4 border-2 rounded-lg transition-all hover:border-magic hover:bg-magic-light/10 dark:hover:bg-magic-dark/20 {selectedRaceIndex ===
                  race.index
          ...
          {:else if selectedRaceDetails}
            <div class="space-y-4 p-4 border rounded-lg bg-neutral-light/10 dark:bg-neutral-dark">
              <div>
                ...
                <div>
                  ...
                  <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                    {#each selectedRaceDetails.ability_bonuses as bonus}
                      <div class="p-2 bg-success-light/20 dark:bg-success-dark rounded">
                        <span class="font-bold text-success-dark dark:text-success-light">
                ...
                <div>
                  ...
                  <div class="space-y-1">
                    {#each selectedRaceDetails.traits as trait}
                      <div class="p-2 bg-info-light/20 dark:bg-info-dark rounded text-sm">
                        {trait.name}
                      </div>
                    {/each}
                  </div>
                  ...
                  {#each abilities as ability}
                    ...
                    <div class="p-2 border rounded">
                      ...
                      <div class="text-lg font-bold">
                        {finalScore}
                        {#if bonus > 0}
                          <span class="text-xs text-success">(+{bonus})</span>
                        {/if}
                      </div>
                      <div class="text-xs text-muted-foreground">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
              {#each availableClasses as characterClass}
                <button
                  ...
                  class="p-4 border-2 rounded-lg transition-all hover:border-magic hover:bg-magic-light/10 dark:hover:bg-magic-dark/20 {selectedClassIndex ===
                ...
                <div>
                  ...
                  <div class="flex gap-2 flex-wrap">
                    {#each selectedClassDetails.saving_throws as savingThrow}
                      <div class="px-3 py-1 bg-warning-light/20 dark:bg-warning-dark rounded text-sm">
                        {savingThrow.name}
                      </div>
                    {/each}
                  </div>
                ...
                <div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-1 text-sm">
                    {#each selectedClassDetails.proficiencies as proficiency}
                      <div class="p-2 bg-info-light/20 dark:bg-info-dark rounded">
                        {proficiency.name}
                      </div>
                    {/each}
                  </div>
